...
FIXME: Dune should communicate the build-path for Pmodlib to the indexer
  ...
  ./_build/default/sub-project/.subprojectlib.objs/byte/subprojectlib.cmt
  ...
  {uid: Dune__exe__Othermod.0; locs:
   ...
   uid: Stdlib.316; locs:
     ...
     "print_int": File "$TESTCASE_ROOT/sub-project/subprojectlib.ml", line 2, characters 9-18
   uid: Subprojectlib.0; locs:
     "subproject_value": File "$TESTCASE_ROOT/sub-project/subprojectlib.ml", line 1, characters 4-20;
     "subproject_value": File "$TESTCASE_ROOT/sub-project/subprojectlib.ml", line 2, characters 19-35
